...
const Enrollments = () => {
  ...
  const getImageUrl = (course) => {
    if (!course?.image)
      return "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=750&h=450&fit=crop";
        ...
        {enrollments.length === 0 ? (
          ...
          >
            ...
            <p className="text-gray-500 mb-8 max-w-md mx-auto">
              Browse our catalog and enroll in courses to start learning new
              skills.
            </p>
            <Link
              to="/courses"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {enrollments.map((enrollment, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl hover:border-primary-200 transition-all duration-500">
                    {/* Image — Links to Watch */}
                    <Link
                    ...
                    <div className="p-5">
                      ...
                      <Link to={`/courses/${course.id}`}>
                        <h3 className="font-display font-bold text-gray-900 text-lg leading-snug mb-3 line-clamp-2 hover:text-primary-600 transition-colors">
                          {course.title}
                        </h3>
                      </Link>
                      ...
                      <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                        <Link
                          to={`/student/courses/${course.id}/watch`}
                          className="flex-1 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-primary-600 to-primary-700 text-white py-2.5 rounded-xl text-sm font-semibold hover:from-primary-700 hover:to-primary-800 transition-all shadow-md shadow-primary-200"
                        >
                          <FiPlay size={14} />
                          Continue Learning
                        </Link>
                        <Link
                          ...
                          className="inline-flex items-center justify-center gap-2 bg-gray-100 text-gray-700 px-4 py-2.5 rounded-xl text-sm font-semibold hover:bg-gray-200 transition-all"
                        >
                          Details
                        </Link>
                      </div>
