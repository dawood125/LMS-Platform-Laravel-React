...
const Register = () => {
  ...
  const getPasswordStrength = () => {
    ...
    if (password.length < 4)
      return { width: "25%", color: "bg-red-500", text: "Weak" };
    if (password.length < 6)
      return { width: "50%", color: "bg-orange-500", text: "Fair" };
    if (password.length < 8)
      return { width: "75%", color: "bg-yellow-500", text: "Good" };
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 items-center justify-center p-12 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-primary-100 text-lg leading-relaxed mb-10">
            Create a free account and get instant access to hundreds of courses
                ...
                {formData.password && (
                  <div className="mt-2">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span
                        className={`text-xs font-medium ${strength.color === "bg-green-500" ? "text-green-600" : strength.color === "bg-yellow-500" ? "text-yellow-600" : strength.color === "bg-orange-500" ? "text-orange-600" : "text-red-600"}`}
                      >
                        {strength.text}
                      </span>
                    </div>
