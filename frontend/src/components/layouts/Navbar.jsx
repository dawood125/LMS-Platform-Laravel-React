...
import { FiBookOpen, FiLogIn, FiLogOut, FiUser, FiPlusCircle, FiGrid, FiSettings } from 'react-icons/fi';
...
const Navbar = () => {
    ...
    const getRoleBadge = () => {
        ...
        if (isInstructor) return { text: 'Instructor', color: 'bg-blue-100 text-blue-700' };
        return { text: 'Student', color: 'bg-green-100 text-green-700' };
    };
                        ...
                        {isAuthenticated ? (
                            <>
                                ...
                                {(isInstructor || isAdmin) && (
                                    <>
                                        ...
                                        <Link to="/instructor/courses/create"
                                            className="ml-1 px-4 py-2 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-xl text-sm font-medium hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-md shadow-primary-200 hover:shadow-lg">
                                            <span className="flex items-center gap-1.5">
                                ...
                                <div className="relative ml-3 group">
                                    ...
                                    <div className="absolute right-0 mt-1 w-56 bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2">
                                        {/* User Info */}
                                        <div className="px-4 py-3 border-b border-gray-50">
                                            <p className="text-sm font-semibold text-gray-900">{user?.name}</p>
                                            <span className={`inline-block text-xs font-semibold px-2 py-0.5 rounded-full mt-1 ${roleBadge.color}`}>
                                                {roleBadge.text}
                                            </span>
                                        </div>
                                ...
                                <>
                                    ...
                                    <div className="px-4 py-2 flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <span className={`inline-block text-xs font-semibold px-2 py-0.5 rounded-full ${roleBadge.color}`}>
                                                {roleBadge.text}
                                            </span>
                                        </div>
                                    </div>
