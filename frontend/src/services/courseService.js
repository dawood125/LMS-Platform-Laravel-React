...
const courseService = {
  ...
  saveCourseImage: (id, data) =>
    apiClient.post(`/save-course-image/${id}`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  changeCourseStatus: (id, data) =>
    apiClient.post(`/change-course-status/${id}`, data),
  deleteCourse: (id) => apiClient.delete(`/courses/${id}`),

  getChapters: (courseId) =>
    apiClient.get("/chapters", { params: { course_id: courseId } }),
  ...
  getLessons: (chapterId) =>
    apiClient.get("/lessons", { params: { chapter_id: chapterId } }),
  ...
  saveLessonVideo: (id, data) =>
    apiClient.post(`/save-lesson-video/${id}`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),

  getOutcomes: (courseId) =>
    apiClient.get("/outcomes", { params: { course_id: courseId } }),
  ...
  getRequirements: (courseId) =>
    apiClient.get("/requirements", { params: { course_id: courseId } }),
